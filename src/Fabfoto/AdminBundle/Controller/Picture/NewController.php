...
use Admingenerated\FabfotoAdminBundle\BasePictureController\NewController as BaseNewController;
...
class NewController extends BaseNewController
{
    ...
    */
    ...
    {
        $this->get('fabfoto_gallery.picture_uploader')->upload($Picture, true);
    }
}
